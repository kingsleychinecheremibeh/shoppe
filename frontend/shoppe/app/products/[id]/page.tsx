            ...
            <div className="border-t border-gray-100 pt-6 mt-auto grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500">On all orders over $150</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <ShieldCheck className="h-5 w-5 text-gray-400 shrink-0" />
                <div>
                  <p className="text-xs font-bold text-gray-900">Warranty Protection</p>
                  <p className="text-[10px] text-gray-500">100% genuine guarantees</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500">30-day change of mind policy</p>
                </div>
              </div>
            </div>
